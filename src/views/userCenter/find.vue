      ...
      <div class="article">
        <div>
          <div class="article-item" v-for="(songCom, index) in songCommentList">
            <img @load="loadImage" src="../../common/image/default.png" alt="" class="user-icon">
            <div class="user-info"> 
            ...
            <div class="artilce-content">
              ...
              <div class="comment-box" v-show="commentShow == index"  @click="sendComment">
                ...
                <div class="comment">
                  <p><span  @click="selectFind('user/userPreview')">龙的传人：</span> {{songCom.comment}}</p>
                </div>  
              </div>
            </div>
          </div>
